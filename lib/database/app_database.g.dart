    ...
    this.changeListener,
        ...
        _notificationModelInsertionAdapter = InsertionAdapter(
            ...
            (NotificationModel item) => <String, Object?>{
                  ...
                  'created_at_ms':
                      _notificationDateTimeConverter.encode(item.createdAt)
                },
            changeListener),
  ...
  Future<List<NotificationModel>> findAll() async {
    return _queryAdapter.queryList(
        ...
        mapper: (Map<String, Object?> row) => NotificationModel(
            ...
            createdAt: _notificationDateTimeConverter
                .decode(row['created_at_ms'] as int)));
  }
        ...
        _teacherInsertionAdapter = InsertionAdapter(
            ...
            (Teacher item) => <String, Object?>{
                  ...
                  'created_at':
                      _notificationDateTimeConverter.encode(item.createdAt),
                  'updated_at':
                      _notificationDateTimeConverter.encode(item.updatedAt)
                }),
  ...
  Future<List<Teacher>> findAll() async {
    return _queryAdapter.queryList('SELECT * FROM teachers',
        mapper: (Map<String, Object?> row) => Teacher(
            ...
            isActive: (row['is_active'] as int) != 0,
            createdAt:
                _notificationDateTimeConverter.decode(row['created_at'] as int),
            updatedAt: _notificationDateTimeConverter
                .decode(row['updated_at'] as int)));
  }
